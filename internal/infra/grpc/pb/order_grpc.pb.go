...
type OrderServiceClient interface {
	...
	GetListOrder(ctx context.Context, in *GetListOrderRequest, opts ...grpc.CallOption) (*ListOrderResponse, error)
}
...
func (c *orderServiceClient) GetListOrder(ctx context.Context, in *GetListOrderRequest, opts ...grpc.CallOption) (*ListOrderResponse, error) {
	out := new(ListOrderResponse)
	err := c.cc.Invoke(ctx, "/pb.OrderService/GetListOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	GetListOrder(context.Context, *GetListOrderRequest) (*ListOrderResponse, error)
...
func (UnimplementedOrderServiceServer) GetListOrder(context.Context, *GetListOrderRequest) (*ListOrderResponse, error) {
...
func _OrderService_GetListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.OrderService/GetListOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
